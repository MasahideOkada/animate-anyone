...
from diffusers.models.attention import GatedSelfAttentionDense, FeedForward

# Adapted from https://github.com/huggingface/diffusers/blob/76c645d3a641c879384afcb43496f0b7db8cc5cb/src/diffusers/models/attention.py#L28
...
class BasicTransformerBlock(nn.Module):
    ...
    def forward(
        ...
        num_frames: int = 1,
        reference_hidden_states: Optional[torch.FloatTensor] = None,
        ...
        return hidden_states, reference_hidden_states
