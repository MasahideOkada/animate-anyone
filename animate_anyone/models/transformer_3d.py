...
class Transformer3DModel(ModelMixin, ConfigMixin):
    ...
    def forward(
        ...
        Args:
            ...
            reference_hidden_states (`Tuple[torch.FloatTensor]` whose `torch.FloatTensor` is of shape `(batch size, channel, height, width)`)
        ...
        for i, block in enumerate(self.transformer_blocks):
            ref_hidden_states = reference_hidden_states[i]
